  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: "products", component: ProductsPage, meta: { title: "Products" } },
        { path: "products/:productId", component: ProductDetailPage, meta: { title: "Product Detail" } },
        ...
        { path: "customers/:customerId", component: CustomerDetailPage, meta: { title: "Customer Detail" } },
